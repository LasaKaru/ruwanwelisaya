  ...
  return (
    <div className="rw-tile-scene rw-tile-scene--golden">
      <svg className="rw-tile-scene__svg" viewBox="0 0 400 500" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
        ...
        <path d="M 0 360 L 80 330 L 160 350 L 240 320 L 320 348 L 400 332 L 400 400 L 0 400 Z" fill="#5a2818" opacity="0.6"/>
...
function SacredNightScene() {
  const stars = [[40,60],[110,30],[180,80],[260,40],[340,70],[380,130],[60,130],[220,140],[300,110],[150,180],[350,200],[80,220],[240,200],[200,250],[380,250],[120,280],[320,290],[20,150]];
  return (
    <div className="rw-tile-scene rw-tile-scene--night">
      <svg className="rw-tile-scene__svg" viewBox="0 0 400 500" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
        <g fill="#fff">
          {stars.map(([x, y], i) => (
            <circle key={i} cx={x} cy={y} r={0.6 + (i % 3) * 0.4} opacity={0.4 + (i % 4) * 0.15} className={`rw-tile-star rw-tile-star--${i % 5}`}/>
          ))}
        </g>
        <g>
        ...
        <path d="M 0 380 L 80 360 L 160 372 L 240 358 L 320 374 L 400 364 L 400 410 L 0 410 Z" fill="#0a0c2a" opacity="0.85"/>
        <g>
  ...
  return (
    <div className="rw-tile-scene rw-tile-scene--devotion">
      <svg className="rw-tile-scene__svg" viewBox="0 0 400 500" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
        ...
        <g fill="#f6ecd8">
          {[{x:60,s:0.95,t:0},{x:110,s:1.1,t:-10},{x:165,s:0.85,t:8},{x:215,s:1.0,t:0},{x:270,s:0.95,t:-8},{x:325,s:1.05,t:-4},{x:370,s:0.85,t:6}].map((p, i) => (
...
function LampOfferingScene() {
  const haloPos = [[80,160],[200,120],[320,160],[60,280],[140,240],[260,240],[340,280],[100,380],[200,360],[300,380]];
  const lampPos = [[80,200],[200,160],[320,200],[60,320],[140,280],[260,280],[340,320],[100,420],[200,400],[300,420]];
  return (
...
function ProcessionScene() {
  const pilgrims = [{x:30,y:460},{x:80,y:443},{x:130,y:430},{x:200,y:420},{x:270,y:430},{x:320,y:443},{x:370,y:460}];
  return (
...
export default function GalleryScene({ kind }: { kind: string }) {
