...
export default function StupaScene({ animated = true }: { animated?: boolean }) {
  return (
    <div className="rw-stupa-scene">
      ...
      <svg className="rw-scene__svg" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <g className={animated ? 'rw-scene__pinnacle-glow' : ''}>
        ...
        <path d="M 610 700 Q 610 480 800 470 Q 990 480 990 700" fill="none" stroke="#fbf4dc" strokeWidth="2" opacity="0.6"/>
